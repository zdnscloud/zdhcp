...
TEST(OptionSpaceTest, constructor) {
    ...
    OptionSpace space("kea", true);
    EXPECT_EQ("kea", space.getName());
...
TEST(OptionSpaceTest, validateName) {
    ...
    EXPECT_FALSE(OptionSpace::validateName(" "));
    EXPECT_FALSE(OptionSpace::validateName(" kea "));
    EXPECT_FALSE(OptionSpace::validateName("kea "));
    EXPECT_FALSE(OptionSpace::validateName(" kea"));
    EXPECT_FALSE(OptionSpace::validateName("kea with-space"));

    // Hyphens and underscores are not allowed at the beginning
    // and at the end of the option space name.
    EXPECT_FALSE(OptionSpace::validateName("-kea"));
    EXPECT_FALSE(OptionSpace::validateName("kea-"));
    EXPECT_FALSE(OptionSpace::validateName("_kea"));
    EXPECT_FALSE(OptionSpace::validateName("kea_"));
...
TEST(OptionSpace6Test, constructor) {
    ...
    EXPECT_THROW(OptionSpace6("kea dhcp"), InvalidOptionSpace);
    EXPECT_THROW(OptionSpace6("kea%dhcp", 2145), InvalidOptionSpace);
}
