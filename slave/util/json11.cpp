...
protected:
    ...
    const T m_value;
    void dump(string &out) const override { kea::util::dump(m_value, out); }
};
...
struct JsonParser final {
    ...
    Json parse_number() {
        ...
        if (str[i] != '.' && str[i] != 'e' && str[i] != 'E'
            ...
            return Json(std::atoi(str.c_str() + start_pos));
        }
        ...
        return Json(std::strtod(str.c_str() + start_pos, nullptr));
    }
